...
if (isset($_GET['ref']) && trim($_GET['ref']) !== "") {
    ...
    if ($userRefResult->num_rows > 0) {
        ...
        // Check if admin-generated referral code
        ...
        if ($adminRefResult->num_rows > 0) {
            ...
            $refError = "Invalid referral code. Please check and try again.";
        }
    }
}
?>
...
<div class="wrapper">
  ...
  <div class="right-box">
      ...
      <?php elseif ($refError !== ""): ?>
          <div class="alert alert-danger"><?php echo $refError; ?></div>
      <?php endif; ?>
      ...
      <form action="actions/register_action.php" method="POST" id="signupForm">
          ...
          <div class="mb-2">
              ...
              <div class="mt-2"><span id="passwordStrength"></span></div>
          </div>
          ...
          <div class="mb-3">
              ...
              <select name="currency" class="form-control" required>
                  <option value="NGN" selected>NGN — Invest with Naira</option>
                  <option value="USDT">USDT — Invest with Tether (USDT)</option>
              </select>
              <small class="text-muted">Choose Naira if local; choose USDT if you plan to deposit Tether.</small>
          </div>
